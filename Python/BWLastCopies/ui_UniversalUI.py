# Form implementation generated from reading ui file 'c:\Users\aky547\GitHub\WorkPrograms\Python\BWLastCopies\UniversalUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.check_bwlastcopies_manual.setGeometry(QtCore.QRect(460, 200, 81, 23))
        ...
        self.savecsv.setGeometry(QtCore.QRect(20, 200, 81, 21))
        ...
        self.label.setGeometry(QtCore.QRect(390, 200, 51, 21))
        self.label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label.setWordWrap(False)
        self.label.setObjectName("label")
        self.frame = QtWidgets.QFrame(self.manual)
        self.frame.setGeometry(QtCore.QRect(630, 110, 541, 151))
        ...
        self.isil_input.setGeometry(QtCore.QRect(50, 10, 61, 21))
        self.isil_input.setObjectName("isil_input")
        self.search_isil = QtWidgets.QToolButton(self.frame)
        self.search_isil.setGeometry(QtCore.QRect(110, 10, 25, 21))
